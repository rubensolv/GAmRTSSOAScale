...
public class RoundRobinEval implements RatePopulation{
	...
	//private static final String pathCentral = "/home/rubens/cluster/ExecAIGASOA/centralSOA";
			...
			for (Chromosome cIA1 : population.getChromosomes().keySet()) {
				...
				for (Chromosome cIA2 : population.getChromosomes().keySet()) {
					if(!cIA1.equals(cIA2)){
						...
						String strConfig = pathCentral+"/"+convertBasicTuple(cIA1)+"#"+convertBasicTuple(cIA2)+"#"+i+"#"+atualGeneration+".txt";
